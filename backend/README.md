...
## Project Structure
    ...
    ├── crimson_firefly_dev_96131  # Django project configurations
...
1. Clone this repo and `cd crimson_firefly_dev_96131`
...
2. Clone this repo and `cd crimson_firefly_dev_96131`
